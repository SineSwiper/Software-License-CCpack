use strict;
use warnings;
package Software::License::CC_BY_NC_3_0;
use base 'Software::License';
# ABSTRACT: Creative Commons Attribution-NonCommercial 3.0 Unported License (CC BY-NC 3.0)

sub name { 'Creative Commons Attribution-NonCommercial 3.0 Unported License (CC BY-NC 3.0)' }
sub url  { 'http://creativecommons.org/licenses/by-nc/3.0/' }
...
Software::License::CC_BY_NC_3_0 - Creative Commons Attribution-NonCommercial 3.0 Unported License (CC BY-NC 3.0)
