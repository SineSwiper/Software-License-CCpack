package Software::License::CC_BY_SA_2_0;
...
# ABSTRACT: Creative Commons Attribution-ShareAlike 2.0 License (CC BY-SA 2.0)

### NOTE: This file was auto-generated using cc-license.sh.  Do not edit this file!

sub name { 'Creative Commons Attribution-ShareAlike 2.0 License (CC BY-SA 2.0)' }
sub url  { 'http://creativecommons.org/licenses/by-sa/2.0/' }
...
Software::License::CC_BY_SA_2_0 - Creative Commons Attribution-ShareAlike 2.0 License (CC BY-SA 2.0)
...
__LICENSE__
   ...
   ANY KIND CONCERNING THE MATERIALS, EXPRESS, IMPLIED, STATUTORY OR
