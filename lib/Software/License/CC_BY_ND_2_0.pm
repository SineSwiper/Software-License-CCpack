package Software::License::CC_BY_ND_2_0;
...
# ABSTRACT: Creative Commons Attribution-NoDerivs 2.0 License (CC BY-ND 2.0)

### NOTE: This file was auto-generated using cc-license.sh.  Do not edit this file!

sub name { 'Creative Commons Attribution-NoDerivs 2.0 License (CC BY-ND 2.0)' }
sub url  { 'http://creativecommons.org/licenses/by-nd/2.0/' }
...
Software::License::CC_BY_ND_2_0 - Creative Commons Attribution-NoDerivs 2.0 License (CC BY-ND 2.0)
...
__LICENSE__
   ...
   below:
    ...
    b. to distribute copies or phonorecords of, display publicly,
       ...
       Collective Works.
    c. For the avoidance of doubt, where the work is a musical
       composition:
   ...
   made subject to and limited by the following restrictions:
    ...
    b. If you distribute, publicly display, publicly perform, or
       publicly digitally perform the Work or Collective Works, You
       ...
       copyright notice or licensing information for the Work. Such
   ...
   8. Miscellaneous
    a. Each time You distribute or publicly digitally perform the Work,
       the Licensor offers to the recipient a license to the Work on
