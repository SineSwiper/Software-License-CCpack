...
License
   ...
   rights to make Adaptations. Subject to Section 8(f), all rights not
   ...
   made subject to and limited by the following restrictions:
    ...
    b. If You Distribute, or Publicly Perform the Work or Collections,
       ...
       if a credit for all contributing authors of the Collection
       appears, then as part of these credits and in a manner at least
       as prominent as the credits for the other contributing authors.
       For the avoidance of doubt, You may only use the credit required
       by this Section for the purpose of attribution in the manner set
   ...
   8. Miscellaneous
    ...
    e. The rights granted under, and the subject matter referenced, in
