use strict;
use warnings;
package Software::License::CC_BY_SA_3_0;
use base 'Software::License';
# ABSTRACT: Creative Commons Attribution-ShareAlike 3.0 Unported License (CC BY-SA 3.0)

sub name { 'Creative Commons Attribution-ShareAlike 3.0 Unported License (CC BY-SA 3.0)' }
sub url  { 'http://creativecommons.org/licenses/by-sa/3.0/' }
...
Software::License::CC_BY_SA_3_0 - Creative Commons Attribution-ShareAlike 3.0 Unported License (CC BY-SA 3.0)
...
* Public Domain -- Where the work or any of its elements is in the
  public domain under applicable law, that status is in no way affected by
  the license.
...
* Other Rights -- In no way are any of the following rights affected by
  ...
  o Rights other persons may have either in the work itself or in how the
...
subject to and limited by the following restrictions:
  ...
  b. You may Distribute or Publicly Perform an Adaptation only under the
     ...
     ShareAlike 3.0 US)); (iv) a Creative Commons Compatible License. If you
     license the Adaptation under one of the licenses mentioned in (iv), you
     must comply with the terms of that license. If you license the
     Adaptation under the terms of any of the licenses mentioned in (i), (ii)
     or (iii) (the "Applicable License"), you must comply with the terms of
     the Applicable License generally and the following provisions: (I) You
     ...
     the Adaptation from You to exercise the rights granted to that recipient
