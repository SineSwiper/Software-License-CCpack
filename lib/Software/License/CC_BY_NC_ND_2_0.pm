package Software::License::CC_BY_NC_ND_2_0;
...
# ABSTRACT: Creative Commons Attribution-NonCommercial-NoDerivs 2.0 License (CC BY-NC-ND 2.0)

### NOTE: This file was auto-generated using cc-license.sh.  Do not edit this file!

sub name { 'Creative Commons Attribution-NonCommercial-NoDerivs 2.0 License (CC BY-NC-ND 2.0)' }
sub url  { 'http://creativecommons.org/licenses/by-nc-nd/2.0/' }
...
Software::License::CC_BY_NC_ND_2_0 - Creative Commons Attribution-NonCommercial-NoDerivs 2.0 License (CC BY-NC-ND 2.0)
...
__LICENSE__
   ...
   made subject to and limited by the following restrictions:
    ...
    c. If you distribute, publicly display, publicly perform, or
       ...
       copyright notices for the Work and give the Original Author
       ...
       Author if supplied; the title of the Work if supplied; and to
       the extent reasonably practicable, the Uniform Resource
       Identifier, if any, that Licensor specifies to be associated
       with the Work, unless such URI does not refer to the copyright
       ...
       the case of a Collective Work, at a minimum such credit will
