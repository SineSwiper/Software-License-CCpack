package Software::License::CC_BY_NC_SA_2_0;
...
# ABSTRACT: Creative Commons Attribution-NonCommercial-ShareAlike 2.0 License (CC BY-NC-SA 2.0)

### NOTE: This file was auto-generated using cc-license.sh.  Do not edit this file!

sub name { 'Creative Commons Attribution-NonCommercial-ShareAlike 2.0 License (CC BY-NC-SA 2.0)' }
sub url  { 'http://creativecommons.org/licenses/by-nc-sa/2.0/' }
...
Software::License::CC_BY_NC_SA_2_0 - Creative Commons Attribution-NonCommercial-ShareAlike 2.0 License (CC BY-NC-SA 2.0)
...
__LICENSE__
   ...
   made subject to and limited by the following restrictions:
    ...
    b. You may distribute, publicly display, publicly perform, or
       ...
       License (e.g. Attribution-NonCommercial-ShareAlike 2.0 Japan).
       You must include a copy of, or the Uniform Resource Identifier
       for, this License or other license specified in the previous
       sentence with every copy or phonorecord of each Derivative Work
